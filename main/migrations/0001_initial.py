# Generated by Django 5.2.5 on 2025-08-24 00:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qtype', models.CharField(choices=[('multiple-choice', 'Multiple Choice'), ('true-false', 'True/False'), ('fill-blank', 'Fill in the Blank'), ('matching', 'Matching'), ('essay', 'Essay'), ('case-study', 'Case Study (MC)'), ('calculation', 'Calculation'), ('chart-radar', 'Chart (Radar)'), ('chart-pie', 'Chart (Pie)'), ('chart-line', 'Chart (Line)'), ('chart-bar', 'Chart (Bar)'), ('chart-doughnut', 'Chart (Doughnut)'), ('chart-polar', 'Chart (Polar)')], max_length=32)),
                ('question', models.TextField()),
                ('options', models.JSONField(blank=True, null=True)),
                ('correct_answer', models.JSONField(blank=True, null=True)),
                ('left_items', models.JSONField(blank=True, null=True)),
                ('right_items', models.JSONField(blank=True, null=True)),
                ('correct_matches', models.JSONField(blank=True, null=True)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('game', 'order'), name='uq_game_order'),
        ),
        migrations.AddIndex(
            model_name='postlike',
